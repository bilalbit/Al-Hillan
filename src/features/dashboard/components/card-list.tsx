...
export const CardList = ({title}: {title:"Popular Content" | "Latest Transactions"}) => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-2">
                {list.map((item) => (
                    <Card key={item.id} className="flex flex-row justify-between items-center gap-4 bg-background p-4">
                        <div className="w-12 h-12 rounded-sm relative overflow-hidden p-4 mr-3">
